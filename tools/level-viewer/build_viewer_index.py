...
Generate tools/level-viewer/index.json for the level viewer: a list of all
...
Usage (from the repo root):
  ...
  python tools/level-viewer/build_viewer_index.py --roots assets/extracted assets/buggy --output tools/level-viewer/index.json
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="Build the level-viewer asset index.")
    ...
    parser.add_argument("--output", default="tools/level-viewer/index.json",
                        help="Output JSON path. Default: tools/level-viewer/index.json")
    args = parser.parse_args(argv)

    # tools/level-viewer/ → repo root

...
public class LootManager : Singleton<LootManager>
{
    ...
    public void Initialize()
    {
        ...
        try
        {
            ...
            LogLootStatistics();
            _initialized = true;
            Logger.WriteLog(LogType.Initialize, "LootManager initialized successfully.");
        }
        catch (Exception ex)
        {
            Logger.WriteLog(LogType.Error, $"LootManager.Initialize failed: {ex.Message}");
    ...
    private void BuildItemIndex()
    {
        ...
        foreach (var kvp in allCloneBases)
        {
            ...
            CloneBaseObjectType type = cloneBase.Type;
            ...
            (CloneBaseObjectType type, short rarity) key = (type, rarity);
